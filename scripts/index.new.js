 ...
 */
 function playSong(songId) {
    let divAllSong = document.getElementsByClassName("child") //the div that wrap of the songs
    for (let divSong of divAllSong) {

        divSong.style.color = "black"
    }
    const currentSong = document.getElementById(songId) //the left green mark when song playing
...
// document.getElementById("add-button").addEventListener("click", handleAddSongEvent)//I did it in line 45
